pipeline {
 ...
 stages {
  ...
  stage('Publish image to Docker Hub') {
            ...
            steps {
        withDockerRegistry([ credentialsId: "docker1", url: "https://hub.docker.com/repository/docker/vvsatyagupta/nikhilnidhi" ]) {
          sh  'sudo docker push vvsatyagupta/nikhilnidhi:latest'
